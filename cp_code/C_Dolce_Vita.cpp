...
int packs =0;
packs=upper_bound(prefix.begin(),prefix.end(),x)-prefix.begin();
// cout<<packs<<"\n";


int ind=packs-1;
if(*--upper_bound(prefix.begin(),prefix.end(),x)==*lower_bound(prefix.begin(),prefix.end(),x))ind--;
int days=0;
