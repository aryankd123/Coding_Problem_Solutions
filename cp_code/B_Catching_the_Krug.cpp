...
bool maxi(int a1, int a2, int a3 ,int a4){
    if(a1<0)return 0;
    if ( (a2 <= 0 || a1 >= a2) && 
         (a3 <=0 || a1 >= a3) && 
         (a4 <= 0 || a1 >= a4) )
...
int flag1=dist5-dist1;
int flag2=dist6-dist2;
int flag3=dist7-dist3;
int flag4=dist8-dist4;
int ct=0;

ct=abs(x1-x2)+abs(y1-y2);
int ans=0;
// if(ct<2){

// if(maxi(flag1,flag2,flag3,flag4) && flag1>=0){cout<<dist5<<"\n";return ;}
// if(maxi(flag2,flag1,flag3,flag4) && flag2>=0){cout<<dist6<<"\n";return ;}
// if(maxi(flag3,flag2,flag1,flag4) && flag3>=0){cout<<dist7<<"\n";return ;}
// if(maxi(flag4,flag2,flag3,flag1) && flag4>=0){cout<<dist8<<"\n";return ;}

// }


// else{
    if(flag1>0)ans=max(dist5,ans);
    if(flag2>0)ans=max(dist6,ans);
    if(flag3>0)ans=max(dist7,ans);
    if(flag4>0)ans=max(dist8,ans);
