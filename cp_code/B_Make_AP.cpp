...
bool divi(int num,int flag){
    if(flag<=0 || num<=0)return 0;
    if(num%flag==0)return 1;
    else return 0;
}
void solve(){
int a,b,c;
...
if((a+c)%2==0 && divi(diff_t,b)){cout<<"YES\n";return ;}
if(divi(b+diff_l,c)){cout<<"YES\n";return ;}
if(divi(b-diff_r,a)){cout<<"YES\n";return ;}
cout<<"NO\n";
//vector<int> v;
//for(int i=0;i<n;i++){
//int x;
